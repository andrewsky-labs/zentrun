...
import logo from '@/assets/logo_zentrun.png'
...
const nextStep = async () => {
  if (currentStep.value < steps.length - 1) {
    if (currentStep.value === 1) {
      if ((!apiKey.value || !baseUrl.value) && selectedProvider.value !== 'ollama' && selectedProvider.value !== 'zentrun') {
        ...
        <div class="min-h-[300px]">
          ...
          <template v-else-if="currentStep === 1">
            <div class="space-y-6 max-w-xs mx-auto">
              ...
              <div class="mt-6 space-y-4">
                <div v-show="selectedProvider !== 'zentrun'" class="flex flex-col gap-2">
                  <Label for="api-url">{{ t('welcome.provider.apiUrl') }}</Label>
                  <Input id="api-url" v-model="baseUrl" :placeholder="t('enter-api-url')" />
                  <div
                ...
                <div v-show="selectedProvider !== 'ollama' && selectedProvider !== 'zentrun'" class="flex flex-col gap-2">
          ...
          <template v-else-if="currentStep === 2">
            ...
            <div class="space-y-4">
              ...
              <div v-if="!providerModelLoading && providerModels.length <= 0">{{ t('no-provider-available') }}</div>
