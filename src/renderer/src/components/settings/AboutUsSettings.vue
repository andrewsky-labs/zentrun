  ...
  <div class="w-full h-full">
    <div class="w-full h-full flex flex-col gap-2">
      <div class="w-full h-full flex flex-col items-center justify-center gap-2">
        <img src="@/assets/logo_zentrun.png" class="w-10 h-10" />
        <div class="flex flex-col gap-2 items-center">
          ...
          <div class="flex gap-2">
            ...
            <a
              class="text-xs text-muted-foreground hover:text-primary flex items-center"
              href="https://github.com/Zentrun/zentrun"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              class="text-xs text-muted-foreground hover:text-primary flex items-center"
              href="https://github.com/Zentrun/zentrun/blob/dev/LICENSE"
              target="_blank"
              rel="noopener noreferrer"
            >
              <Icon icon="lucide:scale" class="mr-1 h-3 w-3" />
              Apache License 2.0 (For non-commercial)
            </a>
          </div>
        </div>
