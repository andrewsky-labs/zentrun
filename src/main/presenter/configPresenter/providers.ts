...
let initialProviders: LLM_PROVIDER_BASE[] = []
...
try {
  ...
  apiType: 'openai',
  apiKey: '',
  baseUrl: 'https://api.zentrun.com/api/v1/',
  enable: true,
  websites: {
    official: 'https://zentrun.com/',
    apiKey: '',
    docs: 'https://zentrun.com/docs',
    models: 'https://zentrun.com/models',
    defaultBaseUrl: 'https://api.zentrun.com/api/v1/'
  }
}]
  } else {
    console.log('Zentrun provider not available, skipping')
  }
} catch (error) {
  console.error('Error loading Zentrun provider:', error)
}
